...
const StepOne = React.createClass ({
    ...
    render() {
        return (
        <div>
          <p>Sign up with your email address or one your social media accounts</p>
          <div style={{width: "47.5%", float: "left", display: "inline-block"}}>
            <TextField
          ...
          <div style={{width: "5%", float: "left", display: "inline-block", position: "relative"}}>
            <div style={{borderLeft:"1px solid #38546d",  borderRight:"1px solid #16222c", height:"80px", position:"absolute", right:"0px", top:"0px" }}></div>
          </div>
          <div style={{width: "47.5%", float: "right", display: "inline-block", textAlign: 'center'}}>
            <RaisedButton
              label="Facebook"
              linkButton={true}
              icon={
